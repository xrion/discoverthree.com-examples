...
//   maxDelta: 0.1, // the max time that's allowed to elapse each frame
//
//   renderer: {
//     alpha: false,
//     antialias: true,
...
export default class App {
  ...
  constructor( spec ) {
    ...
    this.spec.maxDelta = spec.maxDelta || 0.1;
  ...
  update() {
    ...
    if ( delta > this.spec.maxDelta ) delta = this.spec.maxDelta;
  ...
  initStats() {
    ...
    if ( typeof Stats === 'undefined' ) {
      ...
      console.warn( 'The stats.js script is required to show the stats overlay. Please make sure that it has been loaded correctly, or set app.spec.stats to false.' );
      return;
