...
// define attributes, if any (note: ShaderMaterial automatically includes basic attributes such as position)
...
function createShaderMaterial () {
  ...
  const material = new THREE.ShaderMaterial( {
    //uniforms: {}, // optional object containing uniforms and attributes
    vertexShader,
    fragmentShader,
  })
